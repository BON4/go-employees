...
const (
	...
	ErrNoSuchUser         = "Resource not found"
...
var (
	...
	ExistsCredError       = errors.New("Resource with given credentials already exists")
...
func parseSqlErrors(err error) RestErr {
	if strings.Contains(err.Error(), "23505") {
		return NewRestError(http.StatusBadRequest, ExistsCredError.Error(), err)
	}
